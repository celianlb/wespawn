...
export default function Footer() {
    return (
        <div className='bg-var-grey text-white px-6 md:px-[110px] 2xl:container'>
            <div className='font-rnssanz  py-8 flex flex-col space-y-8 md:flex-row md:py-20 md:gap-10'>
                <div className='md:w-1/3 justify-center flex flex-col gap-4 md:gap-6'>
                    <Image 
                        ...
                        alt='WeSpawn Logo'
                    />
                    <p className='text-txt'>L&rsquo;écosystème qui facilite l&rsquo;organisation des compétitions esport pour une immersion professionnelles de tous.</p>
                </div>
            ...
            <div className=' font-rnssanz pb-8 md:pb-20'>
                <hr className='opacity-20 h-[2px] mb-8 z-0' /> 
                <p>© Copyright 2023 | <Link className='underline' href="/mentions-legales">Mentions légales</Link> | Tous droits réservés </p>
            </div> 
        </div>
